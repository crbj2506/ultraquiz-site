<div class="fixed-bottom text-center bg-white container-fluid">
    <div class="row">
        ...
        <div class="col border">
            <span class="text-muted">Desenvolvido por <strong>Custódio Junior</strong>.</span>
        </div>
        <div class="col text-end border">
            <span class="text-muted">Versão: <strong>{{env('SISTEMA_VERSAO')}}</strong> de <strong>{{env('SISTEMA_DATA')}}</strong></span>
        </div>
    </div>
</div>